...
class UserTacticAjax{

    constructor(){
      if(!document.getElementById('tactics-page-identifier')) return;
    ...
    document.getElementById('loading-display').style.display='block';
      ...
      $.ajax({
        ...
        */
        url:chessAppData.root_url + '/wp-json/user/v1/updateUserTactic',
        type:'POST',
        data:{
